...
export default function Navbar() {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            gsap.to(".logo-nav", { opacity: 1, x: 0, duration: 1, ease: "power4.out" });
            gsap.to(".nav-link-anim", {
                opacity: 1,
                y: 0,
                duration: 0.8,
                stagger: 0.1,
            ...
            const mBtn = document.querySelector('.cta-magnetic');
            if (mBtn) {
                const onMouseMove = (e) => {
                    ...
                    gsap.to(mBtn, { x: x * 0.3, y: y * 0.3, duration: 0.5, ease: "power2.out" });
                };
                const onMouseLeave = () => {
                    ...
                    <div className="hidden lg:flex items-center gap-2">
                        {navLinks.map((link, i) => (
                            <Link
                                key={link.name}
                                to={link.path}
                                className={`nav-link-anim opacity-0 px-4 py-2 text-fluid-body font-medium rounded-full transition-all duration-300 ${location.pathname === link.path
                        ...
                        <a
                            ...
                            className="nav-link-anim opacity-0 p-2.5 text-amber-100 hover:text-white transition-colors"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="cta-magnetic ml-4 px-6 py-2.5 text-fluid-body font-medium text-black bg-amber-100 rounded-full hover:bg-white transition-all duration-300 shadow-lg opacity-0"
                        >
                            Cotizar
                        </a>
                    </div>

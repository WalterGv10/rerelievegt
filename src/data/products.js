export const products = [
    ...
    { id: 21, name: 'Arcángel', dimensions: '55cm altura', type: 'Caricatura Volumétrica', detail: 'La Maravilla', image: '/catalog/placeholder.jpg', description: 'Prrrrra.' },
    { id: 22, name: 'Sapo Concho', dimensions: '30cm altura', type: 'Mascota Cultural', detail: 'Acabado Realista', image: '/catalog/placeholder.jpg', description: 'Ícono de la cultura popular.' },
    ...
    { id: 25, name: 'Toretto', dimensions: '55cm altura', type: 'Caricatura Cine', detail: 'Familia', image: '/catalog/placeholder.jpg', description: 'Porque lo más importante es la familia.' },
